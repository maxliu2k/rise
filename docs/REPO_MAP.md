...
- **allan/MERT** — working / historical branch
- **allan/svm** — working / historical branch
- **chore/internal-notes-and-poster-title** — working / historical branch
- **main** — Canonical Philharmonia branch. Presentation + release target.

## Top-level layout

- `README.md` — Project overview and how to run the pipeline.
- `Rise_Musical_Instrument_Classification_FINAL_v2.pdf` — (undocumented)
...
- `internal/` — Working notes, planning docs, and internal review/audit records. Not part of the published method; kept for provenance.
...
- `inband_snr` — (undocumented)
- `mert_ft_model` — (undocumented)
- `paired_model_comparison` — (undocumented)
