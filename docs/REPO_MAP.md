...
- `output/` — (undocumented)
- `paper_merged.tex` — (undocumented)
- `plan.md` — (undocumented)
- `plan_noise.md` — (undocumented)
- `poster_rebuild_editable.pptx` — (undocumented)
- `poster_rebuild_editable.pptx.inspect.ndjson` — (undocumented)
- `poster_rebuild_revised.pptx` — (undocumented)
- `poster_rebuild_revised.pptx.inspect.ndjson` — (undocumented)
...
### Undocumented modules (add to gen_repo_map registry)

- `failure_analysis` — (undocumented)
- `finalize_ast` — (undocumented)
- `finalize_mert_ft` — (undocumented)
- `finalize_panns` — (undocumented)
- `freeze_dataset` — (undocumented)
- `mert_ft_model` — (undocumented)
- `stream_noise_eval` — (undocumented)
- `train_mert_ft` — (undocumented)
- `verify_noise_regeneration` — (undocumented)

## Artifacts present

- `artifacts/ast/`  (+ noise sweep)
- `artifacts/cnn/`  (+ noise sweep)
- `artifacts/crnn/`  (+ noise sweep)
- `artifacts/failure_analysis/`
- `artifacts/mert/`  (+ noise sweep)
- `artifacts/mert_ft/`  (+ noise sweep)
- `artifacts/model_comparisons/`
- `artifacts/panns/`  (+ noise sweep)
- `artifacts/svm/`  (+ noise sweep)
